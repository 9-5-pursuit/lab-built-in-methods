...
function getPercentageScore(score) {
  let roundedInt;
  let percent;
  percent = (score.received/score.max) * 100;
  roundedInt = Math.round(percent)
  return roundedInt;
}
...
function getHighestOfTwoScores(score1, score2) {
  let scores = []
  let score1Percent = (score1.received/score1.max) * 100
  let score2Percent = (score2.received/score2.max) * 100

  scores.push(Math.round(score1Percent))
  scores.push(Math.round(score2Percent))
