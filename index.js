 ...
 */
/* ------- ROUNDED HIGH SCORE PERCENTAGE ------
- assigned 2 vars the percent of score1 and score2 that divides max from receieved multiplied by 100
- returns highest score from both scores and rounds 
*/
function getHighestOfTwoScores(score1, score2) {
  let percent1 = (score1.received / score1.max) * 100;
  let percent2 = (score2.received / score2.max) * 100;
  // console.log(Math.round(Math.max(percent1, percent2)));
  return Math.round(Math.max(percent1, percent2));
}
