 ...
 */
function getPercentageScore(score, received, max) {
 ...
 */
function getHighestOfTwoScores(score1, score2, max) {
  return Math.round(
    Math.max(
      (score1.received / score1.max) * 100,
      (score2.received / score2.max) * 100
    )
  );
}
