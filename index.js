...
function getAssignmentTypes(assignments) {
  let categoriesArray = Object.keys(assignments);
...
function getPercentageScore(score) {
  let scorePercentage = (score.received / score.max) * 100;
...
function getHighestOfTwoScores(score1, score2) {
  // get the percentage of each score using the value received / maximum
  let score1Percentage = (score1.received / score1.max) * 100;
  let score2Percentage = (score2.received / score2.max) * 100;
  // get the highest score
  let highestScore = Math.max(score1Percentage, score2Percentage);
  return Math.round(highestScore);
}
