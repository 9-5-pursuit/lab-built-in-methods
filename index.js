...
function getAssignmentTypes(assignments) {
  let assignmentsObjectKeyNames = Object.keys(assignments);

  return assignmentsObjectKeyNames;
}
...
function getHighestOfTwoScores(score1, score2) {
  let number1 = ((score1.received / score1.max) * 100);
  let number2 = ((score2.received / score2.max) * 100);
