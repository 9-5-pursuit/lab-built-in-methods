...
function getPercentageScore(score) {
  let scorePercent = score.received / score.max * 100
  parseInt(scorePercent)
...
let scorePercent1 = (score1.received/score1.max) * 100
let scorePercent2 = (score2.received/score2.max) * 100
return Math.round(Math.max(scorePercent1, scorePercent2))
}
