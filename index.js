...
function getAssignmentTypes(assignments) {
  //objects.key() is returning an array of all the keys in the object
...
function getPercentageScore(score) {
  // here we use Math.round() to round the number after finding the percentage
...
function getHighestOfTwoScores(score1, score2) {
  // here we use Math.round() to round the number after finding the percentage then with use Math.max() to find the highest score.
