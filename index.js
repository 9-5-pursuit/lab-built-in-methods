...
function getPercentageScore(score) {
  let percScore = score.received/score.max*100
  return Math.round(percScore)
}
...
function getHighestOfTwoScores(score1, score2) {
  let percScore1 = Math.round(score1.received/score1.max*100)
  let percScore2 = Math.round(score2.received/score2.max*100)
  return Math.max(percScore1,percScore2)
}
